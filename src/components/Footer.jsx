        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex gap-4 text-xl text-gray-600">
              <a href="#" className="hover:text-pink-500 transition"><FaGithub /></a>
              <a href="#" className="hover:text-pink-500 transition"><FaTwitter /></a>
              <a href="#" className="hover:text-pink-500 transition"><FaLinkedin /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-600 hover:text-pink-500">Changelog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-gray-600 hover:text-pink-500">Cookies</a></li>
            </ul>
          </div>
        </div>
